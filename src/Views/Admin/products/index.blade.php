            ...
            <div class="white_card card_height_100 mb_30">
                ...
                <div class="white_card_body">
                    ...
                    <div>
                        <ul class="pagination">
                            @if ($page > 1)
                                <li style="margin-right:10px;"><a href="{{ url('admin/products?page=' . ($page - 1 == 0 ? 1 : $page - 1)) }}"
                                        class="prev" title="previous page">&#10094;</a></li>
                            @endif
                            @for ($i = 1; $i <= $totalPage; $i++)
                                <li style="margin-right:10px;">
                                    <a href="{{ url('admin/products?page=' . $i) }}"
                                        class="{{ $page == $i ? 'active' : '' }}">{{ $i }}</a>
                                </li>
                            @endfor
                            @if ($page < $totalPage)
                                <li style="margin-right:10px;"><a href="{{ url('admin/products?page=' . ($page + 1 > $totalPage ? $totalPage : $page + 1)) }}"
